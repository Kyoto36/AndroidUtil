...
public class NetworkUtils {
    ...
    public static Types getNetworkTypes(Context context,Network network){
        ConnectivityManager connManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
        return getNetworkTypes(network,connManager);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public static Types getNetworkTypes(Network network, ConnectivityManager connManager){
        Types types = Types.NONE;
        if(connManager == null) return types;
	...
	public static Types getNetworkTypes(Context context) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                types = getNetworkTypes(network,connManager);
                LogUtils.INSTANCE.i(TAG, "Network info: " + types);
            } else {
                NetworkInfo activeNetworkInfo = connManager.getActiveNetworkInfo();
                LogUtils.INSTANCE.i(TAG, "Active Network info: " + (activeNetworkInfo == null ? "null" : activeNetworkInfo.toString()));
	 ...
	 * @param context
	 * @return
     * @deprecated  use {@link NetworkUtils#isWifiConnected(Context)}  instead
     */
    @Deprecated
	 ...
	 * @param context
	 * @return
     * @deprecated  use {@link NetworkUtils#isMobileConnected(Context)} instead
	 */
    @Deprecated
	 ...
	 * @param context
	 * @return
     * @deprecated  use {@link NetworkUtils#isEthernetConnected(Context)} instead
	 */
    @Deprecated
