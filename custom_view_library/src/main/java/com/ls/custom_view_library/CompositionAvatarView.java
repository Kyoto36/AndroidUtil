...
public class CompositionAvatarView extends View {
    ...
    public static final int DEFAULT_OVERLAP = 4;
    /**
    ...
    private int mOverlap = DEFAULT_OVERLAP;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mGap = a.getDimensionPixelOffset(R.styleable.CompositionAvatarView_gap, DEFAULT_GAP);
        mOverlap = a.getInt(R.styleable.CompositionAvatarView_overlap,DEFAULT_OVERLAP);
        a.recycle();
...
//                if(drawable.mCenterX - center > 0){
//                    drawable.mCenterX -= r / mOverlap / 2 + mGap;
//                }
//                else if(drawable.mCenterX - center < 0){
//                    drawable.mCenterX += r / mOverlap / 2 + mGap;
//                }
//                if(drawable.mCenterY - center > 0){
//                    drawable.mCenterY -= r / mOverlap / 2 + mGap;
//                }
//                else if(drawable.mCenterY - center < 0){
//                    drawable.mCenterY += r / mOverlap / 2 + mGap;
//                }

                updateDrawableBounds(drawable);

                drawable.mMaskPath.addCircle(drawable.mCenterX, drawable.mCenterY, r - mGap,
                        Path.Direction.CW);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < drawables.size(); i++) {
            DrawableInfo drawable = drawables.get(i);
            canvas.drawCircle(drawable.mCenterX, drawable.mCenterY, mSteinerCircleRadius, paint);
            final int savedLayer = canvas.saveLayer(0, 0, mContentSize, mContentSize,
                    null, Canvas.ALL_SAVE_FLAG);
            canvas.rotate(20,drawable.mCenterX, drawable.mCenterY);
