package com.ls.custom_view_library.recyclerview.adapters
...
open class SlideInBottomAnimationAdapter(
  ...
  private var mYRatio = 1

  override fun getAnimators(view: View): Array<Animator> = arrayOf(
    ObjectAnimator.ofFloat(view, "translationY", view.measuredHeight.toFloat() / mYRatio, 0f)
  )

  fun setYRatio(start: Int){
    mYRatio = start
  }
}
